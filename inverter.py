...
while True:
    if datetime.datetime.now().minute % 5 == 0:
		...
		# GoodWe Settings
		GW_IP_ADDRESS   = "10.0.10.130"                                 # Example: 192.168.0.15
		GW_FAMILY       = "ET"                                          # One of ET, EH, ES, EM, DT, NS, XS, BP or None to detect inverter family automatically
		GW_COMM_ADDR    = None                                          # Usually 0xf7 for ET/EH or 0x7f for DT/D-NS/XS, or None for default value
		GW_TIMEOUT      = 5                                             # time in seconds - default 1
		GW_RETRIES      = 3                                             # times to retry - default 3
		GW_INTERVAL     = 30                                            # Ready every # seconds, keep below 60

     # PVoutput Settings
     PVO_SYSTEMID    = "XXXXX"                                       # The System ID from pvoutput.org
